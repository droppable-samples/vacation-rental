...
export const PropertyGrid = () => {
  return <div className="py-8">
      <div className="grid grid-cols-3 gap-6">
        {properties.slice(0, 9).map(property => <PropertyCard key={property.id} imageUrl={property.imageUrl} title={property.title} location={property.location} price={property.price} rating={property.rating} dates={property.dates} />)}
      </div>
    </div>;
};